...
@section("content")
    <main class="space-y-8 p-6 lg:p-10">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500">Kelola transaksi dan operasional armada Buberta Rent.
                </p>
            </div>
                                ...
                                <td>
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-[10px] font-bold uppercase italic tracking-tighter opacity-50">
    ...
    <script>
        function openDeleteModal(id, customerName) {
            ...
            // 1. Set Action URL dinamis (sesuaikan dengan route Laravel Anda)
            form.action = `/rental/${id}`;

            // 2. Set nama customer agar lebih informatif
            namePlaceholder.innerText = customerName;
