    ...
    <main class="mx-auto max-w-5xl space-y-8 p-6 lg:p-10">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-black text-slate-800 lg:text-3xl">Tambah <span class="text-emerald-600">Berita
                            Baru</span></h1>
                    <p class="text-sm text-slate-500">Publikasikan informasi terbaru untuk warga desa.</p>
                </div>
            </div>
        </div>
    ...
    <script>
        function previewImage() {
            ...
            if (input.files && input.files[0]) {
                ...
                // Melepaskan memori setelah gambar dimuat
