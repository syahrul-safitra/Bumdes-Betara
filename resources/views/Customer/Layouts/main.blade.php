                ...
                <div class="mb-12 grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-sm">
                            <li><a href="/" class="transition-colors hover:text-emerald-500">Beranda</a></li>
                            <li><a href="/profil" class="transition-colors hover:text-emerald-500">Profil Desa</a></li>
                            <li><a href="/dokumentasi" class="transition-colors hover:text-emerald-500">Dokumentasi</a>
                            </li>
                            <li><a href="/rental" class="font-bold transition-colors hover:text-emerald-500">Rental
                                    Kendaraan</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-sm">
                            ...
                            <li><a href="#" class="transition-colors hover:text-emerald-500">BUBERTA RENT</a>
                            </li>
                            ...
                            <li><a href="#"
                                    class="font-bold italic text-emerald-400 transition-colors hover:text-emerald-500">LED
                                    BUBERTA</a></li>
