...
class SppLoan extends Model
{
    ...
    protected $fillable = ['group_id', 'no_kontrak', 'plafon_disetujui', 'total_dicairkan', 'bunga_persen', 'tenor_bulan', 'status_loan', 'keperluan', 'status_loan', 'alasan_penolakan_loan', 'status_pencairan', 'file_dokumen_perjanjian', 'nominal_pengajuan', 'bukti_transfer'];
